#Setup and libraries for all processing
...
#Spencer and Mike's functions for downloading data, with gas data filled in 
...
setwd('C://Users/adelv/Dropbox/NEON/CSVs_R/Testrun')
